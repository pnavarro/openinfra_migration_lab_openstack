...
openstack floating ip create public --floating-ip-addres 172.21.0.206
----
...
[source,bash,role=execute]
----
openstack server add floating ip centos10-ch 172.21.0.206
exit
----
...
[source,bash,role=execute,subs=attributes]
----
ssh -i /home/lab-user/.ssh/{guid}key.pub cloud-user@172.21.0.206
----
